      ...
      <aside className="channel-sidebar">
        ...
        <div className="quick-nav-group">
          ...
          <Link to="/apply" style={{ textDecoration: "none" }}>
            <div className={`quick-nav-card ${location.pathname === "/apply" ? "qnc-active qnc-amber" : ""}`}>
              <div className="quick-nav-icon qni-amber">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M12 5v14M5 12h14"/></svg>
              </div>
              <span className="quick-nav-label">Staff Application</span>
              <svg className="quick-nav-chevron" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="9 18 15 12 9 6"/></svg>
            </div>
          </Link>
        </div>
